...
public class main {
	...
	public static void main(String[] args) throws SBOLValidationException, IOException, SBOLConversionException {
		...
		Iterator<File> it = FileUtils.iterateFiles(new File("C:\\Users\\Rakshaal\\Documents\\CelloStuff\\gbfiles\\type\\level0"), new SuffixFileFilter(".csv"), null);
        File f = it.next();
		while(it.hasNext()){
		...
		it = FileUtils.iterateFiles(new File("C:\\Users\\Rakshaal\\Documents\\CelloStuff\\gbfiles\\type\\Level_1_NOR_Gates"), new SuffixFileFilter(".csv"), null);
        f = it.next();
		while(it.hasNext()){
            System.out.println(f.getName().substring(0, f.getName().length()-4));
            DNAPart part = createLevel0Parts(f);
		...
		it = FileUtils.iterateFiles(new File("C:\\Users\\Rakshaal\\Documents\\CelloStuff\\gbfiles\\type\\Level_2_S-R_Latches"), new SuffixFileFilter(".csv"), null);
        f = it.next();
		while(it.hasNext()){
            System.out.println(f.getName().substring(0, f.getName().length()-4));
            DNAPart part = createLevel0Parts(f);
		...
		it = FileUtils.iterateFiles(new File("C:\\Users\\Rakshaal\\Documents\\CelloStuff\\gbfiles\\type\\Level_1_Destination_Vector"), new SuffixFileFilter(".csv"), null);
        f = it.next();
		while(it.hasNext()){
            System.out.println(f.getName().substring(0, f.getName().length()-4));
		...
		it = FileUtils.iterateFiles(new File("C:\\Users\\Rakshaal\\Documents\\CelloStuff\\gbfiles\\type\\Level_2_Destination_Vectors"), new SuffixFileFilter(".csv"), null);
        f = it.next();
		while(it.hasNext()){
            System.out.println(f.getName().substring(0, f.getName().length()-4));
            DNAPart part = createVector(f);
